...
| PremiumCurrency | USD | Currency in which the premium is paid. | null | yes | yes | yes | yes | null | null | yes | yes
| PremiumAmount | -400000 | Premium amount paid or received by 'ClientLegalEntity'. Positive means 'ClientLegalEntity' receives / 'CounterpartyLegalEntity' pays the amount. Negative means the 'ClientLegalEntity' pays / 'CounterpartyLegalEntity receives the amount. | null | yes | yes | yes | yes | null | null | yes | yes
...
| OptionExpirationDate | 2013-11-25 16:00:00 | For option products, the date and time when the option expires. Returns null for non-option products. | null | yes | yes | yes | yes | null | null | yes | yes
...
| EffectiveDate | 2013-10-15 | Date the executed trade is effective. | yes | yes | yes | yes | yes | null | null | null | null
...
| Leg2Direction | Receives Buys | Indicates whether the client buys/receives or sells/receives the product for leg 2 of the transaction. | yes | null | yes | yes | yes | null | null | null | yes
...
| Leg2FxOptionStyle | European | The specific type of FX option used for leg 1 of the transaction. | null | null | null | null | null | null | null | null | yes
...
| Leg2PaymentFrequency | Semi-annually | For interest rate products, the payment frequency of the second leg of the transaction. | yes | null | yes | yes | yes | null | null | null | null
| Leg1Currency | USD | Same as Notional Currency. | yes | yes | yes | yes | yes | yes | yes | yes | yes
| Leg2Currency | GBP | Home Currency, only applies to FX trades and cross currency swaps. | yes | null | yes | yes | yes | null | null | null | yes
...
| Leg2NotionalAmount | 160000 | The notional amount of the corresponding currency.  In an FX trade, this is the exchange amount. | yes | yes | yes | yes | yes | null | null | null | yes
| Leg2NotionalCurrency | INR | The notional currency of leg 2 of the transaction. | yes | null | yes | yes | yes | null | null | null | yes
...
| Leg2StrikeRate | 1.3437 | The agreed upon strike rate, either interest rate or foreign exchange rate, relevant for leg 2 of the transaction. | null | null | yes | null | yes | null | null | null | yes
| Leg1IndexName | USD-PEN | Name of the index being used for leg 1 of the  transaction. | yes | yes | yes | yes | yes | yes | yes | yes | yes
| Leg2IndexName | 3 mo. USD-LIBOR-BBA | Name of the index being used for leg 2 of the  transaction. | yes | null | yes | null | yes | null | null | null | yes
...
| Leg2SpreadOverIndex | 0.025 | The spread to the index being used for leg 2 of the transaction (should return blank if leg is fixed). | yes | null | yes | null | yes | null | null | null | yes
...
| Leg1FxCurrency | PEN | For multi-currency transactions, the "home currency" is set at the time of trade loading. This is the other currency, the "foreign currency". This field returns null for single-currency transactions. | null | null | null | null | null | yes | yes | yes | yes
| Leg1FxCurrencyAmount | -176680.58 | For multi-currency transactions, the "home currency amount" is set at the time of trade loading. This is the other currency, the "foreign currency amount". This field returns null for single-currency transactions. | null | null | null | null | null | yes | yes | yes | yes
| Leg1HomeCurrency | USD | For multi-currency transactions, this is the currency specified as the "home currency" at the time of trade loading. The other currency is the "foreign currency". This field returns null for single-currency transactions. | null | null | null | null | null | yes | yes | yes | yes
| Leg1HomeCurrencyAmount | 62398.23 | For multi-currency transactions, this is the currency specified as the "home currency amount" at the time of trade loading. The other currency is the "foreign currency amount". This field returns null for single-currency transactions. | null | null | null | null | null | yes | yes | yes | yes
| Leg2DayCountFraction | Act/365 Fixed | Indicates the day count method used to determine the number of days between two payment periods, for leg 2 of the transaction | yes | null | yes | yes | yes | null | null | null | null
| Leg2PeriodEndBusinessDayConvention | Modified Following | Specifies the contractual convention of adjusting dates determined in respect to period end date, if period end date falls on a non Business Day. | yes | null | yes | yes | yes | null | null | null | null
| Leg2PaymentBusinessDayConvention | Modified Following | Specifies the contractual convention of adjusting dates determined in respect to a payment date, if payment date falls on a non Business Day. | yes | null | yes | yes | yes | null | null | null | null
| Leg2FxCurrency | INR | For multi-currency transactions, the "home currency" is set at the time of trade loading. This is the other currency, the "foreign currency". This field returns null for single-currency transactions. | null | null | null | null | null | null | null | null | yes
| Leg2FxCurrencyAmount | -200735000 | For multi-currency transactions, the "home currency amount" is set at the time of trade loading. This is the other currency, the "foreign currency amount". This field returns null for single-currency transactions. | null | null | null | null | null | null | null | null | yes
| Leg2HomeCurrency | USD | For multi-currency transactions, this is the currency specified as the "home currency" at the time of trade loading. The other currency is the "foreign currency". This field returns null for single-currency transactions. | null | null | null | null | null | null | null | null | yes
| Leg2HomeCurrencyAmount | 3800000 | For multi-currency transactions, this is the currency specified as the "home currency amount" at the time of trade loading. The other currency is the "foreign currency amount". This field returns null for single-currency transactions. | null | null | null | null | null | null | null | null | yes
...
| Leg1CurrentPeriodFixedRate | 0.035 | For IR trades, the current period fixed rate for leg 1 of the transaction. | yes | yes | yes | yes | yes | null | null | null | null
| Leg1CurrentPeriodFloatingRate | 0.00227 | Index rate applicable to the current period for leg 1 of the transaction. | yes | yes | yes | yes | yes | null | null | null | null
| Leg1CurrentPeriodFloatingRateFixingDate | 2013-10-31 | For IR trades, the current period fixing date used to determine the floating rate in leg 1 of the transaction. | yes | yes | yes | yes | yes | null | null | null | null
| Leg1CurrentPeriodFloatingRateResetDate | 2013-10-31 | For IR trades, the date the floating rate specific to leg 1 of the transaction reset and it is now used to determine payments for the current period. | yes | yes | yes | yes | yes | null | null | null | null
| Leg1CurrentPeriodSpread | 0.0655 | The spread applied to the index for leg 1 of the transaction generated by Chatham upon loading. | yes | yes | yes | yes | yes | null | null | null | null
| Leg1CurrentPeriodStartDate | 2013-11-01 | The start date specified for the current period of this report for leg 1 of the transaction.  | yes | yes | yes | yes | yes | null | null | null | null
| Leg1CurrentPeriodEndDate | 2013-11-30 | The end date specified for the current period of this report for leg 1 of the transaction.  | yes | yes | yes | yes | yes | null | null | null | null
| Leg1CurrentPeriodPaymentDate | 2013-11-31 | The payment date specified for leg 1 of this transaction during the current period. | yes | yes | yes | yes | yes | null | null | null | null
...
| Leg2CurrentPeriodFixedRate | NULL | For IR trades, the current period fixed rate for leg 2 of the transaction. | null | null | yes | null | yes | null | null | null | null
| Leg2CurrentPeriodFloatingRate | 0.0058875 | Index rate applicable to the current period for leg 2 of the transaction. | null | null | yes | null | yes | null | null | null | null
| Leg2CurrentPeriodFloatingRateFixingDate | 2013-10-31 | For IR trades, the current period fixing date used to determine the floating rate in leg 1 of the transaction. | null | null | yes | null | yes | null | null | null | null
| Leg2CurrentPeriodFloatingRateResetDate | 2013-10-31 | For IR trades, the date the floating rate specific to leg 2 of the transaction reset and it is now used to determine payments for the current period. | null | null | yes | null | yes | null | null | null | null
| Leg2CurrentPeriodSpread | 0.0145 | The spread applied to the index for leg 2 of the transaction generated by Chatham upon loading. | null | null | yes | null | yes | null | null | null | null
| Leg2CurrentPeriodStartDate | 2013-11-01 | The start date specified for the current period of this report for leg 2 of the transaction.  | yes | yes | yes | yes | yes | null | null | null | null
| Leg2CurrentPeriodEndDate | 2013-11-30 | The end date specified for the current period of this report for leg 2 of the transaction.  | yes | yes | yes | yes | yes | null | null | null | null
| Leg2CurrentPeriodPaymentDate | 2013-11-31 | The payment date specified for leg 2 of this transaction during the current period. | yes | yes | yes | yes | yes | null | null | null | null
| FxSpotRateCurrencyPair | GBP-AUD | Indicates the currency pair associated with the spot rates given in 'FxSpotRateReportStart' and 'FxSpotRateReportEnd'. | null | null | null | null | yes | yes | yes | yes | yes
| FxSpotRateReportStart | 1.69605 | The start date specified for the foreign exchange spot rate in this report. | null | null | null | null | yes | yes | yes | yes | yes
| FxSpotRateReportEnd | 1.7953 | The end date specified for the foreign exchange spot rate in this report. | null | null | null | null | yes | yes | yes | yes | yes
